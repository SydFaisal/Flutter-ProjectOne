...
main() {
  ...
  List credentials = [
    ...
    ["ZOHAIB", "1234", 40000, "PKMEZN0012345"]
  ];
  while (!login) {
      ...
      while (!log) {
        ...
        if (option == 1) {
          ...
          if (uname == "USMAN KHALIL") {
            ...
            print("");
            print("ACOUNT TITLE:$uname");
            print("CURRENT BALANCE:${credentials[1][2]}");
          } else if (uname == "ZOHAIB") {
            print("");
            print("ACOUNT TITLE:$uname");
            print("CURRENT BALANCE:${credentials[2][2]}");
          }
          print("");
        } else if (option == 2) {
          print("");
          ...
          print("");
          stdout.write(
              "Enter which bill do you want to pay (K.E. - Gas - PTCL - KWSB): ");
